...
find_existing_installations() {
    ...
    # Deduplicate and exclude new location - handle empty array case
    if [[ ${#paths[@]} -gt 0 ]]; then
...
migrate_installation() {
    ...
    git clone -b "$INSTALL_BRANCH" https://github.com/jschwar2552/claude-code-docs.git "$INSTALL_DIR"
    cd "$INSTALL_DIR"
...
# Save for later cleanup - handle empty array case
...
if [[ -f "$INSTALL_DIR/scripts/claude-docs-helper.sh.template" ]]; then
    ...
    if curl -fsSL "https://raw.githubusercontent.com/jschwar2552/claude-code-docs/$INSTALL_BRANCH/scripts/claude-docs-helper.sh.template" -o "$INSTALL_DIR/claude-docs-helper.sh" 2>/dev/null; then
        chmod +x "$INSTALL_DIR/claude-docs-helper.sh"
...
When reading a doc:
📚 ENHANCED MIRROR: https://github.com/jschwar2552/claude-code-docs
...
• 5 hours ago:
  📎 https://github.com/jschwar2552/claude-code-docs/commit/eacd8e1
  📄 data-usage: https://docs.anthropic.com/en/docs/claude-code/data-usage
     ➕ Added: Privacy safeguards
  📄 security: https://docs.anthropic.com/en/docs/claude-code/security
     ✨ Data flow and dependencies section moved here

📎 Full changelog: https://github.com/jschwar2552/claude-code-docs/commits/main/docs
📚 ENHANCED MIRROR - INCLUDES CUSTOM CONTENT
